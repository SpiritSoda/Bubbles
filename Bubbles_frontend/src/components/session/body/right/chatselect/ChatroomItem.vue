...
export default {
    ...
    methods: {
        select_chatroom(){
            this.$store.dispatch('select_chatroom', this.chatroom.id);
        }
    },
    computed:{
        chatroom_background(){
...
.chatroom-icon:hover{
    box-shadow: 0 0px 10px rgb(124, 179, 255);
...
.underline{
    ...
    top: 30px;
    margin: auto;
    background: linear-gradient(to left,rgba(255, 255, 255, 0.0), rgba(150, 150, 150, 1) 70%, rgba(150, 150, 150, 1) 92%, rgba(255, 255, 255, 0.0));
}
.chatroom-online{
    position: absolute;
    top: 20px;
